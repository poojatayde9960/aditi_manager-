    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-6">
        {[...Array(2)].map((_, i) => (
          <div
            key={i}
            className="bg-[#FFFFFF0A] border border-white/10 rounded-2xl p-4 sm:p-6 shadow-lg"
          >
            <div className="animate-pulse space-y-4">
              ...
              {[...Array(5)].map((_, idx) => (
                <div
                  key={idx}
                  className="flex justify-between items-center p-3 sm:p-4 bg-[#020523]/40 rounded-xl"
                >
                  ...
                  <div className="space-y-2 text-right">
                    ...
                    <div className="h-2 bg-slate-700 rounded w-8 mx-auto"></div>
                  </div>
                </div>
              ))}
            </div>
